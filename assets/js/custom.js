...
$(document).ready(function() {
    ...
    var panelDashboardHeight = [],
    panelDashboardDesc      = jQuery('.panel-height'),
    panelDashboardDescLen   = panelDashboardDesc.length-1;
    panelDashboardDesc.each(function(index, value){
        panelDashboardHeight.push(jQuery(this).height());
        if (index == panelDashboardDescLen) {
            panelDashboardDesc.height(Math.max.apply(null, panelDashboardHeight));
        }
    });
